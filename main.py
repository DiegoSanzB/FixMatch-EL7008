...
from models.my_net import NetCN8, NetCN4
...
if __name__ == '__main__':
    ...
    # compute batch_sizes of supervised and unsupervised dataloaders
    ...
    assert len(supervised_loader) == len(unsupervised_loader)   # make sure supervised and unsupervised have same size
    ...
    # obtain metrics with metrics functions
