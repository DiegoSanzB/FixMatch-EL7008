...
if __name__ == '__main__':
    ...
    logger.info(f'Size of supervised dataset {len(Cifar10_supervised)} and unsupervised {len(Cifar10_unsupervised)}')
    ...
    accuracy = accuracy_confusion(labels_true, labels_pred, 'Fixmatch Confusion Matrix')

    plot_loss((supervised_loss, unsupervised_loss, val_loss), ('Supervised', 'Unsupervised', 'Validation'))
